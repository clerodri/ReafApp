 ...
 */
public abstract class Hilt_TodoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TodoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TodoFragment_GeneratedInjector) this.generatedComponent()).injectTodoFragment(UnsafeCasts.<TodoFragment>unsafeCast(this));
    }
  }
