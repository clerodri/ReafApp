 ...
 */
public abstract class Hilt_RecordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecordFragment_GeneratedInjector) this.generatedComponent()).injectRecordFragment(UnsafeCasts.<RecordFragment>unsafeCast(this));
    }
  }
